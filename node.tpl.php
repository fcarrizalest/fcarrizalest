	...
	<article id="cArticle" itemscope itemtype="http://schema.org/Article" >
												...
												<figure class="rowFig" >
												 ...
												 <?php endif; ?>
													...
													<div class="g-plus"   data-height="60" data-href="http://fcarrizalest.com/<?php print $node_url; ?>"></div>
													<div class="g-plusone" data-annotation="vertical-bubble" data-size="tall" data-href="http://fcarrizalest.com/<?php print $node_url; ?>" ></div>
